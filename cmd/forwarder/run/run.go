...
func Command() (cmd *cobra.Command) {
	...
	defer func() {
		...
		fs.VarP(anyflag.NewValue[*url.URL](&url.URL{Scheme: "http", Host: "localhost:8080"}, &c.proxyConfig.LocalProxyURI, forwarder.ParseProxyURI), "local-proxy-uri", "l", "sets local proxy URI")
		...
		fs.VarP(anyflag.NewValue[*url.URL](nil, &c.proxyConfig.UpstreamProxyURI, forwarder.ParseProxyURI), "upstream-proxy-uri", "u", "sets upstream proxy URI")
